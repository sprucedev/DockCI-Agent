...
class ProjectSchema(Schema):
    ...
    utility = fields.Bool()
    status = fields.Str()
    #display_repo = fields.Str()
    branch_pattern = fields.Str()
    github_repo_id = fields.Str()
    github_repo_hook = fields.Str()
    gitlab_repo_id = fields.Str()
    registry_detail = fields.Str()
